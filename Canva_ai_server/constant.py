kprompt = (
        ...
        f"Provide detailed explanation of the answer in the result "
        f"Provide response in template {'Problem Statement: '},{'Hints: [a python list of hints,]'} {'Solution: '}, {'Answer: Result'}"
    )